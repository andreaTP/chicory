(module
  ...
  ;; Uses linear memory as the sieve array
  ;; param: n (i32) - upper bound
  ;; result: count of primes (i32)
  (func (export "sieve") (param $n i32) (result i32)
    ...
    (block $sieve_done
      (loop $sieve_loop
        (br_if $sieve_done (i32.gt_u (i32.mul (local.get $i) (local.get $i)) (local.get $n)))
